...
/* loaded from: TehShop-dex2jar.jar:org/xbill/DNS/LOCRecord.class */
public class LOCRecord extends Record {
    private static final long serialVersionUID = 9058224788126750409L;

    /* renamed from: w2, reason: collision with root package name */
    private static NumberFormat f5263w2;

    /* renamed from: w3, reason: collision with root package name */
    private static NumberFormat f5264w3;
    ...
    static {
        ...
        f5263w2 = decimalFormat;
        decimalFormat.setMinimumIntegerDigits(2);
        DecimalFormat decimalFormat2 = new DecimalFormat();
        f5264w3 = decimalFormat2;
    ...
    public LOCRecord(Name name, int i7, long j7, double d8, double d9, double d10, double d11, double d12, double d13) {
        super(name, 29, i7, j7);
    ...
    private long parseDouble(Tokenizer tokenizer, String str, boolean z7, long j7, long j8, long j9) {
        Tokenizer.Token token = tokenizer.get();
        if (token.isEOL()) {
            if (z7) {
                throw a.u("Invalid LOC ", str, tokenizer);
            }
            tokenizer.unget();
            return j9;
        }
        ...
        try {
            long parseFixedPoint = (long) (parseFixedPoint(str3) * 100.0d);
            if (parseFixedPoint >= j7 && parseFixedPoint <= j8) {
    ...
    private double parseFixedPoint(String str) {
        ...
        return (d8 / Math.pow(10.0d, split[1].length())) + parseInt;
    }

    private static long parseLOCformat(int i7) {
        long j7 = i7 >> 4;
        int i8 = i7 & 15;
        if (j7 > 9 || i8 > 9) {
    ...
    java.lang.NullPointerException: Cannot invoke "jadx.core.dex.instructions.args.InsnArg.getType()" because "changeArg" is null
    	...
    	at jadx.core.dex.visitors.typeinference.TypeInferenceVisitor.visit(TypeInferenceVisitor.java:75)
     */
    /* JADX WARN: Not initialized variable reg: 22, insn: 0x01a4: MOVE (r0 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]) = (r22 I:??[int, float, boolean, short, byte, char, OBJECT, ARRAY]), block:B:73:0x01a4 */
    private long parsePosition(org.xbill.DNS.Tokenizer r8, java.lang.String r9) {
        /*
    ...
    private String positionToString(long j7, char c, char c8) {
        StringBuffer stringBuffer = new StringBuffer();
        ...
        stringBuffer.append(" ");
        renderFixedPoint(stringBuffer, f5264w3, j10 % 60000, 1000L);
        stringBuffer.append(" ");
        stringBuffer.append(c);
        return stringBuffer.toString();
    }

    private void renderFixedPoint(StringBuffer stringBuffer, NumberFormat numberFormat, long j7, long j8) {
    ...
    private int toLOCformat(long j7) {
        byte b8 = 0;
        while (j7 > 9) {
            b8 = (byte) (b8 + 1);
            j7 /= 10;
    ...
    public String rrToString() {
        ...
        stringBuffer.append(" ");
        renderFixedPoint(stringBuffer, f5263w2, this.altitude - 10000000, 100L);
        stringBuffer.append("m ");
        renderFixedPoint(stringBuffer, f5263w2, this.size, 100L);
        stringBuffer.append("m ");
        renderFixedPoint(stringBuffer, f5263w2, this.hPrecision, 100L);
        stringBuffer.append("m ");
        renderFixedPoint(stringBuffer, f5263w2, this.vPrecision, 100L);
        stringBuffer.append("m");
        return stringBuffer.toString();
    }
